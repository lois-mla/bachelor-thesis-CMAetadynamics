...
class MolSimCMA:
    def __init__(self, width, height, number_of_gaussians, nsteps, starting_population_size, pop_increase_factor, cma_number_of_generations, cma_sigma, cma_upper_bound, cma_lower_bound=0):
        self.width = width
        self.height = height
        ...
        self.output_path =  f"output2/sepcma_increasing_pop_size_n{self.number_of_gaussians}_spop{starting_population_size}_popincr{pop_increase_factor}_S{cma_sigma}_nsteps{nsteps}"
...
def plot_cvs_and_heights(cmaObj, gen, cvs, population_size, dir, solutions=None):
    ...
    plt.suptitle(f"pop_size={population_size}")
...
if __name__ == "__main__":
    ...
    test = MolSimCMA(width, height, number_of_gaussians, time_steps, starting_population_size, pop_increase_factor, cma_number_of_generations, cma_sigma, cma_upper_bound, cma_lower_bound)
    test.CMA()
